...
public class PreparoPedidoIniciadoConsumerTest
{
    ...
    private readonly PreparoPedidoIniciadoConsumer _preparoPedidoIniciadoConsumer;

    public PreparoPedidoIniciadoConsumerTest()
    {
        ...
        _preparoPedidoIniciadoConsumer = _fixture.Create<PreparoPedidoIniciadoConsumer>();
    ...
    public async Task DeveExecutarConsumerCompleto()
    {
        ...
        _consumerMock.Setup(x => x.ReceiveMessagesAsync(QueuesNames.PreparoPedidoIniciado.ToString())).ReturnsAsync(response);
        ...
        using (var cancellationTokenSource = new CancellationTokenSource())
        {
            ...
            await _preparoPedidoIniciadoConsumer.StartAsync(cancellationTokenSource.Token);
        }
        ...
        _atualizarPedidoUseCaseMock.Verify(u => u.Handle(It.Is<AtualizarPedidoDto>(dto =>
            ...
            dto.Status == Status.EmPreparacao
        )));
    }
}
